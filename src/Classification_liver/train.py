...
log_dir = '../../results/logs/liver/train'
model_dir = '../../results/models/liver/train'
...
def run(fold):
    ...
    for epoch in range(1, CFG.n_epochs+1):
        ...
        content = time.ctime() + ' ' + f'Fold {fold}, Epoch {epoch}, lr: {optimizer.param_groups[0]["lr"]:.7f}, train loss: {train_loss:.5f}, valid loss: {valid_loss:.5f}, metric: {metric:.6f}, model:{CFG.backbone}.'
        print(content)
