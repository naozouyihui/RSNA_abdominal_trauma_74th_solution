...
class CFG:
    kernel_type = '1007_1bonev2_effv2s_224_30_6ch_augv2_mixupp5_drl3_rov1p2_bs2_lr23e6_eta23e6_75ep_liver'
    load_kernel = None
    load_last = True
    ...
    data_dir = '../../results/data/Segmentation/data/liver'
    data_train_dir = '../../data/rsna-2023-abdominal-trauma-detection/train_images'
    classification_objects = 'liver'
    use_amp = True
    num_workers = 4
    out_dim = 3
